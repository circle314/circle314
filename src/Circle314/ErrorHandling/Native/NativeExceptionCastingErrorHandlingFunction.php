...
namespace Circle314\ErrorHandling\Native;

use \Exception;
use \ErrorException;
use Circle314\ErrorHandling\AbstractErrorHandlingFunction;
use Circle314\Exception\PHPError\WarningException;
use Circle314\Exception\PHPError\ParseException;
use Circle314\Exception\PHPError\NoticeException;
use Circle314\Exception\PHPError\CoreErrorException;
use Circle314\Exception\PHPError\CoreWarningException;
use Circle314\Exception\PHPError\CompileErrorException;
use Circle314\Exception\PHPError\CompileWarningException;
use Circle314\Exception\PHPError\UserErrorException;
use Circle314\Exception\PHPError\UserWarningException;
use Circle314\Exception\PHPError\UserNoticeException;
use Circle314\Exception\PHPError\StrictException;
use Circle314\Exception\PHPError\RecoverableErrorException;
use Circle314\Exception\PHPError\DeprecatedException;
use Circle314\Exception\PHPError\UserDeprecatedException;
